...
y = 0.4 * x.^4 + 3.1 * x.^2 - 162.3 * x - 80.7;
fprintf('\nexample 1.6-C:\n')
fprintf('references the 4th element of array x: %.6f\n', x(4) )
fprintf('references the 4th element of array y: %.6f\n', y(4) )
...
y = 0.4 * x.^4 + 3.1 * x.^2 - 162.3 * x - 80.7;
fprintf('references 7th element of array x: %.6f\n', x(7) )
fprintf('references 7th element of array y: %.6f\n', y(7) )
