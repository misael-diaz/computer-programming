...
public class Arrays
{
  ...
  public static void main (String[] args)
  {
    ...
    for (int i = 0; i != size; ++i)
    {
      y[i] = 0.4 * Math.pow(x[i], 4) + 3.1 * Math.pow(x[i], 2) - 162.3 * x[i] - 80.7;
    }
    ...
    // performs element addressing
    System.out.printf("references the 7th element of x: %12.6f\n", x[6]);
    System.out.printf("references the 7th element of y: %12.6f\n", y[6]);
    System.out.println("");
