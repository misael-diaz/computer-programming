...
public class SearchAlgorithms
{
	...
	/*
	 * Synopsis:
	 * Performs a successful search, the algorithm looks
	 * for a value which is actually in the list.
	 *
	 */
	{
	...
	/*
	 * Synopsis:
	 * Performs a failed search, the algorithm looks
	 * for a value which is not in the list.
	 *
	 */
	{
