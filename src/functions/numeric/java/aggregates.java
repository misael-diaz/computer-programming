...
class Aggregates
{
  ...
  //
  // Output:
  // large	largest value in the array of doubles
  ...
  //
  // Output:
  // total	sums the elements in the array of doubles
  ...
  public static double median (double [] list)
  {
    ...
    if (list.length % 2 == 0)
      mid = ( FindKthLargest(M, list) + FindKthLargest(M - 1, list) ) / 2.0;
    else
  ...
  // double FindKthLargest (int K, double [] list)
  //
  // Synopsis:
  ...
  //
  // Ouput
  // list[p]	returns the pivot element, the kth largest element counting from zero.
  ...
  private static double FindKthLargest (int K, double [] list)
  {
    ...
    int b = 0;			// begin
    int e = list.length;	// end, non-inclusive
    double [] ls = copy(list);	// creates a shallow copy of the list
  ...
  // int partition (double [] list, int b, int e)
  //
  // Synopsis:
  ...
  // int left (double [] list, int b, int e, int p)
  //
  // Synopsis:
  ...
  // int right (double [] list, int b, int e, int p)
  //
  // Synopsis:
  ...
  // int remove (double [] list, int m, int e, int p)
  //
  // Synopsis:
  ...
  private static void isAscending(double [] list)
  {
    ...
    {
      if (list[i] > list[i + 1])
	throw new RuntimeException("list is not in ascending order");
    }
  }
