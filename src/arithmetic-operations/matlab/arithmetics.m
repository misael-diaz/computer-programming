...
% uses format long to display numeric quantities
format long g

% examples:

% example 1.1-A
fprintf("example 1.1-A:")
(5 - 19/7 + 2.5^3) ^ 2

% example 1.1-B
fprintf("example 1.1-B:")
7 * 3.1 + sqrt(120)/5 - 15^(5/3)

% example 1.2-A
fprintf("example 1.2-A:")
nthroot(8 + 80/2.6, 3) + exp(3.5)

% example 1.3-A
fprintf("example 1.3-A:")
(23 + nthroot(45, 3) ) / (16 * 0.7) + log10(589006)

% example 1.4-D
fprintf("example 1.4-D:")
1.0 / sqrt(5.0e-2) + 2.0 * log10( 4.5e-3 / 3.7 + ...
    2.51 / (1.8e6 * sqrt(2.5e-1) ) )

% example 1.5-A
fprintf("example 1.5-A:")
