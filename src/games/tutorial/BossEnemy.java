...
public class BossEnemy extends GameObject
{
  ...
  public BossEnemy (int x, int y, ID id, Color color, int width, int height,
		    ID spawns, Handler handler)
  {
  ...
  public void tick ()	// initial tick method
  {
    ...
    // updates its position and velocity otherwise
    if ( isDestroyed() )
    {
  ...
  private void fire ()			// fires enemies at the player
  {
    ...
    switch (spawns)	// spawns enemies acording to the type that the boss spawns
    {
      case BasicEnemy:
	// spawns basic enemy
	BasicEnemy basic = new BasicEnemy (posX, posY, spawns, color, handler);
	...
	break;
      ...
      case FastEnemy:
	// spawns fast enemy
	FastEnemy fast = new FastEnemy (posX, posY, spawns, color, handler);
